...
#path = "~vrbouza/www/Miscelánea/2020_04_03_plots_eff_shiftsoff_pakike/"
#path = "~vrbouza/www/Miscelánea/2020_04_03_plots_eff_shiftsoff_pajaime/"
path = "~vrbouza/www/Miscelánea/2020_04_15_plots_eff_shiftsoff_pakike/"

openingpath  = "./results_pakike_2020_04_15/"
#openingpath  = "./results/"
#openingpath  = "/nfs/fanae/user/palencia/effsDTntuple/DTNtuples/test/resultsKike/"
#openingpath  = "/nfs/fanae/user/palencia/effsDTntuple/DTNtuples/test/resultsStandardKike/"
...
def combineresplots(hlist, qual = "", pued = False, ind = "", zoom = "normal"):
    ...
    secondtext = r.TLatex()
    #if pued: toDisplay = r.TString("3000 fb^{-1}, 200 PU, p_{T}>20 GeV")
    #else:    toDisplay = r.TString("3000 fb^{-1}, 0 PU, p_{T}>20 GeV")
    if pued: toDisplay = r.TString("3000 fb^{-1}, 200 PU")
    else:    toDisplay = r.TString("3000 fb^{-1}, 0 PU")
    ...
    thirdtext = r.TLatex()
    thirdtext.SetTextSize(0.0275)
    thirdtext.SetTextAlign(31)
    thirdtext.DrawLatexNDC(0.26, 0.865, "p_{T}>20 GeV")
    secondtext.Draw("same")
    #c.SetLogy()
